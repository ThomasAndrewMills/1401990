...
function initialize() {
    ...
    google.maps.event.addListener(infowindow, 'domready', function() {
        ...
        iwBackground.children(':nth-child(1)').attr('style', function(i,s){ return s + 'left: 136px !important;'});

        // Moves the arrow 76px to the left margin.
        iwBackground.children(':nth-child(3)').attr('style', function(i,s){ return s + 'left: 136px !important;'});
